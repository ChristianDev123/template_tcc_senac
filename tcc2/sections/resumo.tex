...
e \gls{cloud_computing} (Computação em Nuvem), com transmissão da imagem capturada para
...
por modelos inteligentes nativos. O que favorece o \textit{\gls{retrofitting}} como alternativa mais economicamente viável. 
...
latência de ponta a ponta (ms), consumo energético por leitura (mAh). Espera-se que os resultados orientem a escolha arquitetural
