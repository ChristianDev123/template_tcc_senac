...
para sistemas de telemetria de hidrômetros analógicos: \gls{edge_computing} (Computação em Borda), 
...
entre os nós de borda e o gateway central é realizada via rede \gls{lorawan},
...
\noindent
\textbf{Palavras-chave}: Telemetria. ESP32. LoRaWan. OCR.
\end{resumo}
