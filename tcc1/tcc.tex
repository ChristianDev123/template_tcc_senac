...
Alguns algoritmos que aqui avaliamos serem benéficos para a otimização deste tipo de abordagem são os algoritmos de Bounding Box e Dilação Morfológica, algoritmos esses que são amplamente utilizados em modelos de visão computacional com o objetivo de encontrar núcleos de informações em imagens.
