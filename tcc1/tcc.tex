...
Os resultados mostraram que o desenvolvimento deste tipo de ferramente é totalmente viável, e em suma, o experimento foi bem sucedido. 
No entanto, a solução apresenta limitações, uma delas é a utlização de edge-computing aplicado a um hardware que possui recursos severamente limitados, impactando diretamente na utlização de recursos energéticos, em um sistema que urge o foco em baixo consumo de energia e memória, outro ponto a ser abordado é a limitação da câmera na captura de imagens, necessitando de uma adaptação em lente para haver a capacidade de captura de dados próximos. 
