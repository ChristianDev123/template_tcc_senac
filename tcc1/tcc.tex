...
Com o objetivo de mitigar as perdas mencionadas anteriormente, a computação aplicada propõe o uso de dispositivos de Internet das Coisas (IoT). Porém, a implementação dessas redes de monitoramento contínuo possui um gargalo de suma importância em relacionado à gestão energética.
...
Portanto, aqui esclarecemos a necessidade de implementar um sistema eficiente energeticamente com o objetivo de prolongar a vida útil de um dos mais vitais componentes dos nossos dispositivos e reduzir a necessidade de manutenção nos aparelhos desenvolvidos.
...
O trabalho propõe uma arquitetura de computação centralizada que alia técnicas de Reconhecimento Óptico de Caracteres (OCR) à implementação de um pipeline ETL integrado. 
Essa abordagem permite a extração de dados analógicos gerando informação estratégica, focando no baixo consumo de energia e processamento em borda, oferecendo um estudo de caso robusto sobre a viabilidade técnica de redes IoT de baixo custo.
