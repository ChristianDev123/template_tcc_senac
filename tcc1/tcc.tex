...
\begin{enumerate}
    \item Implementar os dois fluxos de processamento que compõem o experimento comparativo: o fluxo Edge, em que o OCR ocorre localmente no ESP32; e o fluxo Cloud, em que a imagem é transmitida para processamento remoto. % 1. construção do experimento
    \item Configurar a rede LoRaWan conectando os nós da rede e configurando-a com o objetivo de reduzir ao máximo o consumo energético; % 2. Configuração da infrastrutura de rede
