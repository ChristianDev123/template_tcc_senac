...
\subsection{Redução de Tamanho de Imagens}
...
Conforme apresentado na tabela 3, aplicando os algoritmos citados anteriormente, alcançamos significativos avanços em relação a redução do tamanho da imagem enviada.

\begin{table}[h!]
    \centering
    \caption{Níveis de compressão utilizando algoritmo PNG: 160 x 120 px (Média Consolidada em bytes)}
    \vspace{2mm}
    \begin{tabular}{cccc}
        \toprule
