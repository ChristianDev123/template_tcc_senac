...
A gestão eficiente de recursos hídricos consolidou-se como um dos pilares fundamentais da sustentabilidade urbana contemporânea. Diante de cenários recorrentes de escassez e da pressão crescente sobre as bacias hidrográficas, a digitalização da medição de consumo apresenta-se como uma ferramenta estratégica para a identificação de desperdícios e a compreensão de padrões de uso. Entretanto, a modernização dessa infraestrutura enfrenta desafios técnicos e financeiros significativos, especialmente no que tange à confiabilidade das transmissões de longo alcance e à autonomia energética de dispositivos com recursos computacionais restritos.

Nesse cenário, este trabalho propõe o desenvolvimento de um sistema telemétrico voltado para hidrômetros analógicos. A solução integra o uso de microcontroladores de baixo consumo para a digitalização de leituras e um pipeline ETL para a extração, transformação e carga dos dados, visando atender à demanda de monitoramento em áreas privadas de pequeno e médio porte.
...
Diante de tal problemática, abre-se a discussão sobre os graves impactos na gerência de hídricos e financeiros aos usuários da rede de distribuição, concessionárias e ao governo.
...
% Deixar o template por enquanto para fazer o rascunho. 
