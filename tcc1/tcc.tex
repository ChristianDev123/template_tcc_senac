...
Diante da alta complexidade de implementação, possível menor acurácia de modelos de visão computacional em borda, estando suscetível à qualidade de treinamento de modelo de reconhecimento óptico, e menor adaptabilidade de modelo de sistema para solução em diversos outros projetos, a maior pauta abordada por este trabalho é avaliar onde é mais efetivo, menos custoso e mais vantajoso manter o processamento em soluções IOT que abordam o tema de medição de recursos hídricos.

Tais questionamentos revelam-se intrigantes, ao ser inviável a adoção de modelos e frameworks exaustivamente utilizados e testados em computação em borda, e a versatilidade de processamento de dados não estruturados em ambiente centralizado, em contrapartida, apresenta-se novos desafios ao modelo centralizado proposto em questão de gerenciamento energético, e viabilidade de transmissão de dados em rede de baixa largura de banda.
