...
Um dos maiores desafios dentro da tecnologia atual é a gestão e prolongamento máximo da vida útil das baterias que alimentam devices de diferentes finalidades.
...
Como explicado por XXX em XXX, há diversos fatores que impactam na escolha mais racional da bateria utilizada em devices IOT, entre eles: densidade energética, range de temperatura de funcionamento, segurança, eficiência energética, longevidade e custo. Ainda em tal artigo evidência-se, como um forte candidato a este tipo de aplicação a escolha de bateria de íon-lítio, onde com o passar do tempo, tornou-se mais viável economicamente e oferecendo bons níveis de todos os parâmetros citados anteriormente.
...
Apesar da necessidade de redução das perdas hídricas, a atualização tecnológica da medição enfrenta barreiras econômicas severas. A substituição integral de parques de hidrômetros mecânicos por medidores inteligentes demanda um investimento inicial de capital que pode variar entre 200 e 400 dólares por unidade \cite{mordor2026}. Esse custo elevado constitui o principal entrave para a adoção de tecnologias de telemetria em larga escala, conforme demonstrado em estudos de viabilidade econômica do setor \citeonline{polimi2020}.

Como alternativa viável, a digitalização de dispositivos analógicos preexistentes — processo de modernização adaptativa — permite dotar a infraestrutura atual de inteligência com custos reduzidos. Ao acoplar módulos de baixo custo, como o ESP32, aos medidores já instalados, evita-se a necessidade de intervenções estruturais complexas. A relevância social desta abordagem reside na democratização do controle de consumo, permitindo que o usuário identifique vazamentos de forma célere e mitigue o desperdício.

Academicamente, a pesquisa justifica-se pela implementação prática de técnicas de Reconhecimento Óptico de Caracteres (OCR) em hardware de processamento limitado. A integração entre a coleta de dados via LoRaWAN e o processamento sistemático através de um pipeline ETL oferece um estudo de caso sobre a viabilidade de redes IoT urbanas integradas a dashboards para a geração de conhecimentos estratégicos.
% ---------------------------------------------------------------
\section{Objetivo}
\label{sec:objetivo}
...
Toda via, surge ao mesclarmos tais conceitos, o desafio de alinhar o menor consumo de recurso energético possível, com o objetivo de prolongar a vida útil de bateria dos devices utilizados, às mais otimizadas soluções de rede, hardware e técnicas de desenvolvimento de software.
