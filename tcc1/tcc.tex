...
O cenário brasileiro de saneamento aponta perdas na distribuição de água potável. Como apresentado no jornal \citeonline{g1_desperdicio_2026} o desperdício de recurso hídrico no Brasil hoje representa a considerável fatia de 39,5\% de todo o volume distribuído à população. Em áreas privadas, a ausência de monitoramento em tempo real impossibilita a detecção precoce de vazamentos e anomalias.
