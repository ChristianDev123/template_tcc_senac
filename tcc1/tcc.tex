...
\begin{table}[ht]
\centering
\caption{Especificações dos componentes de hardware utilizados.}
\label{tab:componentes_hardware}
\begin{tabularx}{\textwidth}{@{} l X X @{}}
\toprule
\textbf{Componente} & \textbf{Função Principal} & \textbf{Característica Chave para o Projeto} \\ \midrule
ESP32-CAM & Captura e processamento & Baixo custo e suporte a redes Wi-Fi. \\ \addlinespace
Interface Serial & Programação/Debug & Ponte USB-TTL para gravação de código. \\ \bottomrule
\end{tabularx}
\end{table}
