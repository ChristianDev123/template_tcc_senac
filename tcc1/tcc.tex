...
Em um mundo cada vez mais consciente sob a escassez de recursos hídricos, torna-se imprescindível o desenvolvimento de novas ferramentas de medição.

Sistemas interconectados de alta confiabilidade, baixo custo de implantação e menor necessidade de manutenção são requisitos de uma boa solução para a problemática. 

Sob a ótica tecnológica, encontramos grandes desafios na implementação de um sistema focado em atacar tal questão, entre eles destacam-se a otimização e implementação de algoritmos e protocolos com objetivo de redução de consumo energético, redução de processamento e maximização da confiabilidade na transmissão de dados.

Este trabalho tem como objetivo desenvolver um sistema telemétrico de baixo custo, alta confiabilidade e baixa necessidade de manutenção para áreas privadas de pequeno/médio porte.

% ---------------------------------------------------------------
\section{Contexto}
\label{sec:contexto}

Sob um cenário de escassez hídrica, e de um contínuo desperdício entre 35\% a 40\% de água potável em áreas urbanas, torna-se necessário o acompanhamento periódico para identificação de anomalias e previsibilidade de consumo de recursos hídricos. 

No âmbito acadêmico, há uma lacuna na abordagem para a solução do problema em áreas privadas de pequeno/médio porte, onde em tais obras, em suma, não há uma preocupação com o recurso consumido pelo próprio sistema telemétrico, e nem a geração de insights de utilizando conceitos de ciência de dados.

Para a computação este tema possui grande relevância ao abordarmos principalmente o desenvolvimento e um sistema não focado em melhor desempenho, mas sim voltado para menor consumo possível e ainda sim atendendo todas as demandas que o problema propõe.

Para a sociedade, uma ferramenta de baixo custo de implementação e alto poder no auxílio de tomada de decisões entrega um alto valor agregado.
...
O desenvolvimento de um sistema telemétrico com o objetivo de digitalizar medidores hídricos, provém uma ferramenta de grande valor para a sociedade, atacando um grande problema social urbano que é o desperdício de água em áreas privadas.

Dentro do âmbito acadêmico, o desenvolvimento de sistemas não focados em desempenho não é algo tão estudado nem tão corriqueiro, o estudo e aprofundamento na prática de um sistema empenhado em reduzir o consumo energético é um relevante avanço do conhecimento na área.

Diante dessas duas faces encontramos duas lacunas passíveis de atuação que é o desenvolvimento e aprofundamento de um sistema focado em economia de recurso energético aliado a um hardware de baixo poder computacional e atuando sobre um problema social que temos como objetivo mitigá-lo.
